# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/models.hpatchtst.ipynb.

# %% auto 0
__all__ = ['SinCosPosEncoding', 'HTranspose', 'get_activation_fn', 'PositionalEncoding', 'Coord2dPosEncoding',
           'Coord1dPosEncoding', 'positional_encoding', 'RevIN', 'HPatchTST_backbone', 'Flatten_Head', 'HTSTiEncoder',
           'TSTEncoder', 'TSTEncoderLayer', 'HPatchTST']

# %% ../../nbs/models.hpatchtst.ipynb 5
import math
import numpy as np
...
class HTSTiEncoder(nn.Module):  # i means channel-independent
    """
    HTSTiEncoder
    """
    ...
    def __init__(
        ...
        if "batch" in norm.lower():
            self.norm_attn = nn.Sequential(
                HTranspose(1, 2), nn.BatchNorm1d(hidden_size), HTranspose(1, 2)
            )
        else:
...
class HPatchTST(BaseWindows):
    ...
    The HPatchTST model is an efficient Transformer-based model for multivariate time series forecasting.
